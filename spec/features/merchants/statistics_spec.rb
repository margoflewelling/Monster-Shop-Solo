...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      @bob = User.create!({name: "Bob", street_address: "22 dog st", city: "Fort Collins",
      ...
      @order_1 = Order.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, user_id: @bob.id)
      @order_2 = Order.create!(name: 'Brian', address: '123 Zanti St', city: 'Denver', state: 'CO', zip: 80204, user_id: @bob.id)
      @order_3 = Order.create!(name: 'Mike', address: '123 Dao St', city: 'Denver', state: 'CO', zip: 80210, user_id: @bob.id)
