...
RSpec.describe 'As a visitor' do
  it 'I see top 5 most popular items on the item index page' do
    ...
    @pens = @mike.items.create(name: "Yellow Pencil", description: "You can write on paper with it!", price: 5, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 10)
    @gloves = @meg.items.create(name: "Yellow Pencil", description: "It's a glove!!", price: 25, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 40)
    @chains = @meg.items.create(name: "Yellow Pencil", description: "It's a chain!", price: 9, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 23)
    @leggings = @meg.items.create(name: "Yellow Pencil", description: "It's a legging!", price: 30, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 59)
    @index_cards = @mike.items.create(name: "Yellow Pencil", description: "It's an index card!", price: 83, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 9)
    @folders = @mike.items.create(name: "Yellow Pencil", description: "It's a folder!", price: 8, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 19)
    @helmet = @meg.items.create(name: "Yellow Pencil", description: "It's a helmet!", price: 12, image: "https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg", inventory: 62)
